pipeline {
    ...
    steps {
        sh '''
            ...
            docker build -t digdigdigdig/dark:${BUILD_NUMBER} .
            docker tag digdigdigdig/dark:${BUILD_NUMBER} digdigdigdig/dark:latest
        '''
    }
}
        stage('Push Docker') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerhub', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                    sh '''
                        ...
                        docker push digdigdigdig/dark:${BUILD_NUMBER}
                        docker push digdigdigdig/dark:latest
                    '''
                }
            }
        }
